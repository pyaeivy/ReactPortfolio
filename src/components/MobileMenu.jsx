...
export const MobileMenu = ({menuOpen, setMeunOpen})=>{
    ...
    return (
        <div className={`fixed top-0 left-0 w-full bg-[rgba(10,10,10,.8)] z-40 flex flex-col items-center justify-center
                        ...
                        `}>
              <button onClick={ ()=>setMeunOpen(false) } 
              className="absolute top-3 right-6 text-white text-3xl focus:outline-none cursor-pointer"
